...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: 
    Hello, I am **Muhammad Khairi Norizan**, but you can call me **Khairi**. My major is *Software             Engineering*. I am on my last semester, hopefully I can graduate in flying colors. I cannot                wait for December.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: 
    I am not 100% sure. But from where I work, there is position for Data Scientist. Also, I have              heard about Machine Learning Engineer. From what I know, the job scope for these positions is              that they need to built a machine that can figure the best new store location, gathering data              for type of products most customer buying, and more.
    
    [https://www.glassdoor.com/Job-Descriptions/Data-Scientist.htm]
    
    ```{r, echo=FALSE}
    # Define variable containing url
    url <- "https://2.bp.blogspot.com/-lmGXrd7wyMY/VhZHM4TAzQI/AAAAAAAABwA/WOTo6Fz4-i0/s1600/data-scientist.jpg"
    ```
    ![](`r url`)
    
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: Well, in last Data Science class, my teammate and I were interested in Traffic Accident in the             United States. In this class, I think I am open to Health and Retail.
...
6. To check that your R and Rstudio installation is correct, find the version of R by entering `version` into the R console. Include this command into a R code trunk in your solution `Rmd` file to have it automatically printed in the knitted html file. 
    ...
    Answer: Built with `r getRversion()`
